...
const HTTP_BEARER_TOKEN = process.env.HTTP_BEARER_TOKEN || undefined; // for authentication
...
if (NODE_ENV === 'production') {
  if (!HTTP_BEARER_TOKEN) {
    console.error("HTTP_BEARER_TOKEN is not defined in production environment.");
    process.exit(1);
  }
